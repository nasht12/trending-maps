...
const mapOptions = {
  ...
  center: { lat: 47.67890675865474, lng: -122.33791141508078 },
  zoom: 14,
...
export default function CrabOverlay() {
  return (
    <div className="m-5">
...
function MapComponent() {
  ...
  const [lat, setLat] = useState("47.67890675865474");
  const [lng, setLng] = useState("-122.33791141508078");
  const ref = useRef();
...
function createTransitionOverlay(map) {
  ...
  overlay.onAdd = () => {
    ...
    loader.loadAsync("models/crab/scene.gltf").then((object) => {
